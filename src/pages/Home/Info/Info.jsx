  ...
  return (
    <div>
      <section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100">
        <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4 justify-items-center">
          <div className="flex flex-col sm:flex-row p-4 sm:space-x-4 dark:bg-gray-900 dark:text-gray-100 text-center sm:text-left">
